#ifndef MLE_BITMAPBUTTON_H
#define MLE_BITMAPBUTTON_H
...
class SOWIN_DLL_API MleBitmapButton {

public:
  MleBitmapButton(HWND parent,
                    int x,
                    int y,
                    int width = 30,
                    int height = 30,
  ...
  typedef void ClickedProc(MleBitmapButton * button, void * userdata);
  void registerClickedProc(ClickedProc * func, void * userdata);

private:
  class MleBitmapButtonP * pimpl;
  friend class MleBitmapButtonP;
};

// *************************************************************************

#endif // ! MLE_BITMAPBUTTON_H
