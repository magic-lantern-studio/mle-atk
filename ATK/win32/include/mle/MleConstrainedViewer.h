...
#ifndef MLE_CONSTRAINEDVIEWER_H
#define MLE_CONSTRAINEDVIEWER_H

#include <mle/MleFullViewer.h>

// ************************************************************************

class SOWIN_DLL_API MleConstrainedViewer : public MleFullViewer {
  SOWIN_OBJECT_ABSTRACT_HEADER(MleConstrainedViewer, MleFullViewer);
...
protected:
  MleConstrainedViewer(HWND parent,
...
private:
  class MleConstrainedViewerP * pimpl;
};

// ************************************************************************

#endif // ! MLE_CONSTRAINEDVIEWER_H
