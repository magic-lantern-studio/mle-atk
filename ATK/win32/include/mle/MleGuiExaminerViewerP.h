#ifndef MLEGUIEXAMINERVIEWERP_H
#define MLEGUIEXAMINERVIEWERP_H
...
// MleGuiExaminerViewer class.

class MleGuiExaminerViewerP
{
public:
  ~MleGuiExaminerViewerP();
...
protected:
  MleGuiExaminerViewerP(MleExaminerViewer * publ);
  MleExaminerViewer * pub;
};

// ************************************************************************

#endif // ! MLEGUIEXAMINERVIEWERP_H
