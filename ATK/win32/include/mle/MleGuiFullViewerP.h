#ifndef MLEGUIFULLVIEWERP_H
#define MLEGUIFULLVIEWERP_H
...
// MleGuiFullViewer class.

class MleGuiFullViewerP
{
public:
  ~MleGuiFullViewerP();
...
protected:
  MleGuiFullViewerP(MleFullViewer * publ);
  MleFullViewer * pub;
};

// ************************************************************************

#endif // ! MLEGUIFULLVIEWERP_H
