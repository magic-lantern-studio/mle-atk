...
// src/Inventor/Win/viewers/MleConstrainedViewer.cpp.  Generated from SoGuiConstrainedViewer.cpp.in by configure.

/*!
  \class MleConstrainedViewer Inventor/Win/viewers/MleConstrainedViewer.h
  \brief The MleConstrainedViewer class is the superclass for viewers with constrains on the viewpoint.
  ...
  using MleConstrainedViewer::setUpDirection()) or the end-user,
...
class MleConstrainedViewerP {
public:
  MleConstrainedViewerP(MleConstrainedViewer * owner) {
    this->publ = owner;
  }
...
void
MleConstrainedViewerP::rotateCamera(const float delta) const
{
...
SOWIN_OBJECT_ABSTRACT_SOURCE(MleConstrainedViewer);
...
/*!
  Constructor.
*/
MleConstrainedViewer::MleConstrainedViewer(HWND parent,
...
{
  PRIVATE(this) = new MleConstrainedViewerP(this);

  this->setClassName("MleConstrainedViewer");
...
/*!
  Virtual destructor.
*/
MleConstrainedViewer::~MleConstrainedViewer()
{
  delete PRIVATE(this);
}
...
*/
void
MleConstrainedViewer::setUpDirection(const SbVec3f & dir)
{
...
*/
const SbVec3f &
MleConstrainedViewer::getUpDirection(void) const
{
...
// doc in super
void
MleConstrainedViewer::setCamera(SoCamera * newcam)
{
...
// doc in super
void
MleConstrainedViewer::saveHomePosition(void)
{
...
// doc in super
void
MleConstrainedViewer::resetToHomePosition(void)
{
...
*/
void
MleConstrainedViewer::tiltCamera(float delta)
{
...
// doc in super
void
MleConstrainedViewer::bottomWheelMotion(float value)
{
...
// doc in super
void
MleConstrainedViewer::leftWheelMotion(float value)
{
...
// doc in super
void
MleConstrainedViewer::changeCameraValues(SoCamera * camera)
{
...
*/
void
MleConstrainedViewer::findUpDirection(SbVec2s mouselocation)
{
  ...
  // is what MleConstrainedViewer::getSceneGraph() would return).
...
*/
void
MleConstrainedViewer::checkForCameraUpConstrain(void)
{
  SoCamera * cam = this->getCamera();
  assert(cam);
