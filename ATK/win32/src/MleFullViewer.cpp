...
// src/Inventor/Win/viewers/MleFullViewer.cpp.  Generated from MleGuiFullViewer.cpp.in by configure.

// This file contains the generic, "templatize-able" parts of the
// So*FullViewer sourcecode.

/*!
  \class MleFullViewer MleFullViewer.h Inventor/Win/viewers/MleFullViewer.h
  \brief The MleFullViewer class adds some user interface components to the viewer canvas.
  \ingroup components viewers

  The MleFullViewer is an abstract viewer class which extends it's
  ...
  user interfaces of the MleFullViewer's non-abstract subclasses.
  ...
  The non-abstract subclasses of the MleFullViewer class are
...
/*!
  \fn void MleFullViewer::createViewerButtons(HWND parent, SbPList * buttonlist)
  ...
  MyExaminerViewer::MyExaminerViewer(HWND parent)
    : SoWinExaminerViewer(parent, NULL, TRUE,
                            MleFullViewer::BUILD_ALL, MleFullViewer::BROWSER,
...
*/
/*!
  \var MleFullViewer::BuildFlag MleFullViewer::BUILD_NONE

  Do not add any of the user interface components.
*/
/*!
  \var MleFullViewer::BuildFlag MleFullViewer::BUILD_DECORATION

  Only build and set up the decorations around the OpenGL canvas.
*/
/*!
  \var MleFullViewer::BuildFlag MleFullViewer::BUILD_POPUP

  Only build the popup menu. (Activated with the right mousebutton.)
*/
/*!
  \var MleFullViewer::BuildFlag MleFullViewer::BUILD_ALL

  Build all user interface components of the MleFullViewer.
*/

/*!
  \var HWND MleFullViewer::leftDecoration
  The root widget for the left-side decorations.
*/

/*!
  \var HWND MleFullViewer::leftWheel
  The widget representing the thumbwheel left of the render canvas.
*/

/*!
  \var HWND MleFullViewer::leftWheelLabel
  Label widget of left wheel.
*/

/*!
  \var char * MleFullViewer::leftWheelStr
  Text of left thumbwheel's label.
*/

/*!
  \var float MleFullViewer::leftWheelVal
  Current value of the left thumbwheel.
*/

/*!
  \var HWND MleFullViewer::bottomDecoration
  The root widget for the bottom decorations.
*/

/*!
  \var HWND MleFullViewer::bottomWheel
  The widget representing the thumbwheel below the render canvas.
*/

/*!
  \var HWND MleFullViewer::bottomWheelLabel
  Label widget of bottom wheel.
*/

/*!
  \var char * MleFullViewer::bottomWheelStr
  Text of bottom thumbwheel's label.
*/

/*!
  \var float MleFullViewer::bottomWheelVal
  Current value of the bottom thumbwheel.
*/

/*!
  \var HWND MleFullViewer::rightDecoration
  The root widget for the right-side decorations.
*/

/*!
  \var HWND MleFullViewer::rightWheel
  The widget representing the thumbwheel on the right side of the render canvas.
*/

/*!
  \var HWND MleFullViewer::rightWheelLabel
  Label widget of right wheel.
*/

/*!
  \var char * MleFullViewer::rightWheelStr
  Text of right thumbwheel's label.
*/

/*!
  \var float MleFullViewer::rightWheelVal
  Current value of the right-side thumbwheel.
*/

/*!
  \var SoWinPopupMenu * MleFullViewer::prefmenu
  Pointer to the popup menu instance.
*/

/*!
  \fn MleFullViewer::MleFullViewer(HWND parent, const char * name, SbBool embed, MleFullViewer::BuildFlag buildFlag, SoWinViewer::Type type, SbBool build)
...
/*!
  \fn MleFullViewer::~MleFullViewer()

  Destructor.
*/

/*!
  \fn void MleFullViewer::setDecoration(const SbBool enable)
...
/*!
  \fn SbBool MleFullViewer::isDecoration(void) const
...
/*!
  \fn void MleFullViewer::setPopupMenuEnabled(const SbBool enable)
...
/*!
  \fn SbBool MleFullViewer::isPopupMenuEnabled(void) const
...
/*!
  \fn HWND MleFullViewer::getAppPushButtonParent(void) const
...
/*!
  \fn void MleFullViewer::addAppPushButton(HWND newButton)
...
/*!
  \fn void MleFullViewer::insertAppPushButton(HWND newButton, int index)
...
/*!
  \fn void MleFullViewer::removeAppPushButton(HWND oldButton)
...
/*!
  \fn int MleFullViewer::findAppPushButton(HWND oldButton) const
...
/*!
  \fn int MleFullViewer::lengthAppPushButton(void) const
...
/*!
  \fn HWND MleFullViewer::getRenderAreaWidget(void) const

  Returns the render area OpenGL canvas widget.
*/

/*!
  \fn void MleFullViewer::buildDecoration(HWND parent)

  Build viewer decorations.
*/

/*!
  \fn HWND MleFullViewer::buildLeftTrim(HWND parent)
...
/*!
  \fn HWND MleFullViewer::buildBottomTrim(HWND parent)
...
/*!
  \fn HWND MleFullViewer::buildRightTrim(HWND parent)
...
/*!
  \fn HWND MleFullViewer::buildAppButtons(HWND parent)
...
/*!
  \fn HWND MleFullViewer::buildViewerButtons(HWND parent)

  Build and layout viewer specified button row.
*/

/*!
  \fn void MleFullViewer::buildPopupMenu(void)
  ...
  MleFullViewer::createViewerButtons().
*/

/*!
  \fn void MleFullViewer::openPopupMenu(const SbVec2s position)

  NOTE: This method is not part of the original InventorXt API.
*/

/*!
  \fn void MleFullViewer::setLeftWheelString(const char * const string)

  Set label of the left thumbwheel.
*/

/*!
  \fn void MleFullViewer::setBottomWheelString(const char * const string)

  Set label of the bottom thumbwheel.
*/

/*!
  \fn void MleFullViewer::setRightWheelString(const char * const string)
...
*/
void
MleFullViewer::leftWheelStart(void)
{
...
*/
void
MleFullViewer::leftWheelMotion(float value)
{
...
*/
void
MleFullViewer::leftWheelFinish(void)
{
...
*/
void
MleFullViewer::setLeftWheelValue(const float value)
{
  this->leftWheelVal = value;
  // Wheel may not be constructed yet, but we need to be robust, as
  // set*WheelValue() is used from subclasses.
  if (this->leftWheel) {
    MleFullViewerP::setThumbWheelValue(this->leftWheel, value);
  }
}
...
*/
float
MleFullViewer::getLeftWheelValue(void) const
{
...
*/
void
MleFullViewer::bottomWheelStart(void)
{
  this->interactiveCountInc();
}
...
*/
void
MleFullViewer::bottomWheelMotion(float value)
{
...
*/
void
MleFullViewer::bottomWheelFinish(void)
{
  this->interactiveCountDec();
}
...
*/
void
MleFullViewer::setBottomWheelValue(const float value)
{
  this->bottomWheelVal = value;
  // Wheel may not be constructed yet, but we need to be robust, as
  // set*WheelValue() is used from subclasses.
  if (this->bottomWheel) {
    MleFullViewerP::setThumbWheelValue(this->bottomWheel, value);
  }
}
...
*/
float
MleFullViewer::getBottomWheelValue(void) const
{
...
*/
void
MleFullViewer::rightWheelStart(void)
{
  this->interactiveCountInc();
}
...
*/
void
MleFullViewer::rightWheelMotion(float value)
{
...
*/
void
MleFullViewer::rightWheelFinish(void)
{
  this->interactiveCountDec();
}
...
*/
void
MleFullViewer::setRightWheelValue(const float value)
{
  this->rightWheelVal = value;
  // Wheel may not be constructed yet, but we need to be robust, as
  // set*WheelValue() is used from subclasses.
  if (this->rightWheel) {
    MleFullViewerP::setThumbWheelValue(this->rightWheel, value);
  }
}
...
*/
float
MleFullViewer::getRightWheelValue(void) const
{
...
HWND
MleFullViewer::getLeftWheelLabelWidget(void) const
{
...
*/
HWND
MleFullViewer::getRightWheelLabelWidget(void) const
{
...
*/
HWND
MleFullViewer::getBottomWheelLabelWidget(void) const
{
...
*/
void
MleFullViewer::setPopupMenuString(const char * name)
{
  PRIVATE(this)->popupmenutitle = name;
  if (this->prefmenu) { this->prefmenu->setMenuTitle(MleGuiFullViewerP::ROOT_MENU, name); }
}


// Documented in superclass.
SbBool
MleFullViewer::processSoEvent(const SoEvent * const ev)
{
...
MleGuiFullViewerP::MleGuiFullViewerP(MleFullViewer * owner)
{
  this->pub = owner;
}

MleGuiFullViewerP::~MleGuiFullViewerP()
{
}

SoWinPopupMenu *
MleGuiFullViewerP::setupStandardPopupMenu(void)
{
  ...
  menu->addMenuSelectionCallback(MleGuiFullViewerP::menuSelectionCallback,
                                 (void *) this);
...
void
MleGuiFullViewerP::prepareMenu(SoWinPopupMenu * menu)
{
  //// Misc. //////////////////////////////////////////////////////////
  ...
  //// Basic drawstyles. //////////////////////////////////////////////
  this->setDrawStyleMenuActivation(MleFullViewer::STILL,
                                   PUBLIC(this)->getDrawStyle(MleFullViewer::STILL));
  this->setDrawStyleMenuActivation(MleFullViewer::INTERACTIVE,
                                   PUBLIC(this)->getDrawStyle(MleFullViewer::INTERACTIVE));
  ...
  default:
#if SOWIN_DEBUG
    SoDebugError::postInfo("MleGuiFullViewerP::prepareMenu",
...
void
MleGuiFullViewerP::menuSelection(int menuitemid)
{
  SbBool ok;
...
#if SOWIN_DEBUG
    SoDebugError::postInfo("MleGuiFullViewerP::menuSelection",
  ...
  case VIEW_ALL_ITEM:
    ...
    break;
  case SEEK_ITEM:
    ((MleFullViewerP *)this)->seekbuttonClicked();
    break;
...
void
MleGuiFullViewerP::menuSelectionCallback(int menuitemid,
                                        void * userdata)
{
  MleGuiFullViewerP * viewer = (MleGuiFullViewerP *) userdata;
...
void
MleGuiFullViewerP::setDrawStyleMenuActivation(SoWinViewer::DrawType type,
...
#if SOWIN_DEBUG
      SoDebugError::postWarning("MleFullViewer::setDrawStyleMenuActivation",
...
void
MleGuiFullViewerP::drawstyleActivated(int menuitemid)
{
  switch (menuitemid) {
  case SINGLE_BUFFER_ITEM:
...
// direction vector.
//
// Used from both MleGuiPlaneViewer and MleGuiExaminerViewer.
// Implemented in the MleGuiFullViewer private class to collect common
// code.
void
MleGuiFullViewerP::pan(SoCamera * cam,
...
#if SOWIN_DEBUG && 0
  SoDebugError::postInfo("MleGuiFullViewerP::pan",
                         "was(%.3g, %.3g) -> now(%.3g, %.3g)",
...
// code.
void
MleGuiFullViewerP::zoom(SoCamera * cam, const float diffvalue)
{
  if (cam == NULL) return; // can happen for empty scenegraph
  ...
  if (t.isDerivedFrom(SoOrthographicCamera::getClassTypeId())) {
    ...
    if (!t.isDerivedFrom(SoPerspectiveCamera::getClassTypeId()) &&
      ...
      if (first) {
        SoDebugError::postWarning("MleGuiFullViewerP::zoom",
                                  "Unknown camera type, "
