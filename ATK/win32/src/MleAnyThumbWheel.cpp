...
// src/Inventor/Win/widgets/MleAnyThumbWheel.cpp.  Generated from MleAnyThumbWheel.cpp.in by configure.
...
/*!
  \class MleAnyThumbWheel MleAnyThumbWheel.h
...
/*!
  \var int MleAnyThumbWheel::dirtyTables
  If this flag is set, the internal tables needs to be recalculated.
*/

/*!
  \var int MleAnyThumbWheel::dirtyVariables
...
MleAnyThumbWheel::MleAnyThumbWheel(
  void)
: diameter(0)
, width(0)
, byteorder(ABGR)
...
void
MleAnyThumbWheel::setColorFactors(
...
void
MleAnyThumbWheel::getColorFactors(
  float & lightref,
  float & frontref,
  float & normalref,
...
int
MleAnyThumbWheel::getNumBitmaps(
  void) const
{
...
float
MleAnyThumbWheel::calculateValue(
  const float origval,
  const int origpos,
...
int
MleAnyThumbWheel::getBitmapForValue(
  const float value,
...
void
MleAnyThumbWheel::setGraphicsByteOrder(
...
MleAnyThumbWheel::GraphicsByteOrder
MleAnyThumbWheel::getGraphicsByteOrder(
  void) const
{
...
MleAnyThumbWheel::Movement
MleAnyThumbWheel::getMovement(
  void) const
{
...
void
MleAnyThumbWheel::setBoundaryHandling(
...
MleAnyThumbWheel::BoundaryHandling
MleAnyThumbWheel::getBoundaryHandling(
  void) const
{
...
void
MleAnyThumbWheel::validate(// private
  void) const
{
  int i;
...
void
MleAnyThumbWheel::drawDisabledWheel(// private
  const int number,
  void * bitmap,
  Alignment alignment) const
{
...
void
MleAnyThumbWheel::drawEnabledWheel(
  const int number,
  void * bitmap,
  Alignment alignment) const
{
